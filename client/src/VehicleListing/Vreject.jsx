...
export const Vapprove = () => {
  ...
  return (
    <div >
      ...
      <div className="text-6xl mb-9 flex justify-center font-semibold font-mono gap-7 tracking-wide " > <span className='text-buttonColor flex flex-row font-semibold font-mono gap-7 tracking-wider'> Vehicle</span>Rejected</div>
